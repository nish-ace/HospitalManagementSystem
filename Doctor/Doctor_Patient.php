...
<body>
    ...
    <div class="page">
        ...
        <div id="nav-container">
            ...
            <div id="nav-content" tabindex="0">
                <ul>
                    ...
                    <li><a href="Doctor_Patient.php"  class="active">Patient details</a></li>
        ...
        <p>Adding yet another pure CSS technique to the list of off-screen navigation by "hacking" the :focus-within pseudo-class. Have a look at the code to see how it works.</p> -->
                ...
                ?>
                <form method="POST" style="position: fixed;top: 2.5cm;right:12.85cm;">
                ...
                <table style="width: 50%;">
                    ...
                    <tbody style="text-align: center;">
                        ...
                        $id = $_SESSION['d_id'];
                        $date = $_POST['date'];
                        $stmt = $conn->prepare("SELECT p.p_id, p.Fname, p.Lname, p.sp_required, p.appointment_slot, p.appointment_date FROM appointment a RIGHT JOIN patient p ON a.p_id = p.p_id WHERE a.d_id = '$id' AND a.Date = '$date'");
                        $stmt->execute();
                        ...
                        for ($i = 1; $i <= $k; $i++) {
                            $pid = $result[$i - 1]['p_id'];
                            $name = $result[$i - 1]['Fname'] . ' ' . $result[$i - 1]['Lname'];
                            $sp = $result[$i - 1]['sp_required'];
                            ...
                            echo <<<qq
                                <tr>
                                    ...
                                    <td>
                                        <form action = "Doctor_Diagnosis.php" method = "POST">
                                            <input type = "hidden" name = "pp" value = "$pid">
                                            <input type = "submit" name = "p" value = Diagnose>
                                        </form>
                                    </td>
                                </tr>
                            qq;
