...
<body>
    ...
    <form action="" method="POST">
        ...
        <div class="box2">
            ...
            <table style="width:76%">
                ...
                <tr>
                    <td>
                        <label for="mobile2">Alternate Contact: </label>
                    </td>
                    <td>
        ...
        <div class="box3">
            <table style="width:58%">
                ...
                <td>
                    ...
                    <td>
                        <select id="deg" name="deg" class="form-control">
                            ...
                            <option value="bvsc">B.V.Sc & AH</option>
    ...
    <?php
        if(isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['age']) && isset($_POST['gender']) && isset($_POST['email']) && isset($_POST['address1']) && isset($_POST['mobile']) && isset($_POST['city']) && isset($_POST['mobile2']) && isset($_POST['code']) && isset($_POST['country-state']) && isset($_POST['country']) && isset($_POST['deg']) && isset($_POST['exp']) && isset($_POST['institute']) && isset($_POST['sp']) && isset($_POST['pswd']) && isset($_POST['cpswd']) && isset($_POST['year']))
        {   
    ...
    <?php
        if(isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['age']) && isset($_POST['gender']) && isset($_POST['email']) && isset($_POST['address1']) && isset($_POST['mobile']) && isset($_POST['city']) && isset($_POST['mobile2']) && isset($_POST['code']) && isset($_POST['country-state']) && isset($_POST['country']) && isset($_POST['deg']) && isset($_POST['exp']) && isset($_POST['institute']) && isset($_POST['sp']) && isset($_POST['pswd']) && isset($_POST['cpswd']) && isset($_POST['year']))
        {
            ...
            $exp = $_POST['exp'];
            $query = "INSERT INTO doctor VALUES (NULL,'$fname', '$lname', '$age', '$gender', '$email', '$mobile1', '$address', '$city', '$pin', '$state', '$country', '$year','$degree', '$institute', '$specialization', '$password', '$mobile2', '$exp','','','','')";
