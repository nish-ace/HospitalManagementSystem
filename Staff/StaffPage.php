  ...
  <div class="page">
    ...
    <div id="nav-container">
      ...
      <div id="nav-content" tabindex="0">
        <ul>
          <li><a href="StaffPage.php" class = "active">Home</a></li>
          <!-- <li><a href="Patient_Appointment.php">Appointments</a></li> -->
          <!-- <li><a href="http://localhost:90/Project/Patient/PatientPrescription.php">Diagnosis Report</a></li> -->
          <li><a href="http://localhost:90/Project/Staff/StaffLogin.php">Log Out</a></li>
    ...
    <main>
      ...
      <?php
        ...
        $query = "SELECT * FROM staff WHERE (Email = '$uname')";
