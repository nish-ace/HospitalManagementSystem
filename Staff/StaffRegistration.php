...
<body>
    ...
    <form action="" method="POST">
        ...
        <div class="box1">
            ...
            <table style="width: 68%;">
                    <tr>
                        <th style="width: 4.4cm;"></th>
                        <th style="width: 5cm;"></th>
                        <th style="width: 2.5cm;"></th>
                        <th style="width: 4.2cm;"></th>
            ...
            <table style="width:70%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <label for="lastcompany"> Last working place: </label>
                        </td>
                        <td>
    ...
    <?php
        // if(isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['age']) && isset($_POST['gender']) && isset($_POST['email']) && isset($_POST['address1']) && isset($_POST['mobile']) && isset($_POST['city']) && isset($_POST['mobile2']) && isset($_POST['code']) && isset($_POST['country-state']) && isset($_POST['country']) && isset($_POST['degree']) && isset($_POST['lastcompany']) && isset($_POST['pswd']) && isset($_POST['cpswd']))
        // {
    ...
    if(isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['age']) && isset($_POST['gender']) && isset($_POST['email']) && isset($_POST['address1']) && isset($_POST['mobile']) && isset($_POST['city']) && isset($_POST['mobile2']) && isset($_POST['code']) && isset($_POST['country-state']) && isset($_POST['country']) && isset($_POST['degree']) && isset($_POST['lastcompany']) && isset($_POST['pswd']) && isset($_POST['cpswd']))
        {
            ...
            if($_POST['pswd'] !== $_POST['cpswd']){
                ...
                $query = "INSERT INTO staff VALUES ('11900','$fname', '$lname', '$age', '$gender', '$email', '$mobile1', '$mobile2', '$address', '$city', '$pin', '$state', '$country', '$degree', '$lastcompany', '$password')";
