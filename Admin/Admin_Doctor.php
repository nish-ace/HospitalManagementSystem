...
<body>
  ...
  <div class="page">
    <header tabindex="0" style="font-size: 35px;">Doctor Information</header>
    <div id="nav-container">
      ...
      <div id="nav-content" tabindex="0">
        <ul>
          ...
          <li><a href="Admin_Doctor.php" class="active">Doctor details</a></li>
        ...
        <table style="border: 1px solid black;">
          ...
          <tbody style="text-align: center;">
            ...
            for ($i = 1; $i <= $k; $i++) {
              ...
              $yog = $result[$i - 1]['YearOfGraduation'];
              $degree = $result[$i - 1]['Degree'];
              $institute = $result[$i - 1]['Institute'];
              $sp = $result[$i - 1]['Specialization'];
              $exp = $result[$i - 1]['Experience'];
              echo <<<qq
