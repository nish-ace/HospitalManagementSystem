...
<body>
  <div>
    <header tabindex="0" style="font-size: 35px;">Staff Information</header>
    <div id="nav-container">
      ...
      <div id="nav-content" tabindex="0">
        <ul>
          ...
          <li><a href="Admin_Staff.php"  class="active">Staff details</a></li>
